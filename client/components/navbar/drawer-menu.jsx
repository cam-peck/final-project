  ...
  return (
    <div className={`fixed top-0 ${isOpen} bottom-0 w-52 x2s:w-60 surface-bg-color opacity shadow-xl flex flex-col justify-between rounded-br-xl transition-left ease-in-out duration-200 md:hidden z-20`}>
      <section>
        ...
        <div onClick={() => { props.setOpen(false); }} className="flex flex-col pb-4 gap-1 border-b-2 border-gray-500 m-2">
          <NavItems drawerIsOpen={true}/>
          <button onClick={() => { props.setOpen(false); handleSignOut(); }} className="w-full p-4 pl-3.5 flex items-center text-lg transition-all ease-in-out duration-200 hover:bg-gray-400 hover:bg-opacity-20">
