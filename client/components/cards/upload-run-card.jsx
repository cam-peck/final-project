  ...
  return (
    <section className="flex flex-col mb-4 pt-1">
      ...
      <div className="bg-blue-200 flex justify-between items-center rounded-br-xl rounded-bl-xl px-5 py-3">
        ...
        <label htmlFor="file-input" className="bg-blue-600 text-white px-7 py-3 rounded-3xl hover:cursor-pointer active:transform active:translate-y-[1px] select-none">Upload data</label>
