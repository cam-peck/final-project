...
export default function DistanceInput(props) {
  return (
    <fieldset className="flex pl-4 pr-4 mb-4">
      <legend className="font-lora font-md text-md pb-2">Distance</legend>
      <div className="w-full">
        <input type="number" name="distance" min="0.01" max="999" step="0.01" value={props.value} onChange={props.onChange} className="w-full px-3 py-4 text-center border border-gray-300 text-gray-900 rounded-tl-lg rounded-bl-lg" placeholder="0.00" required />
      </div>
