  ...
  return (
    <fieldset className="flex gap-2 mb-4">
      ...
      <div className="flex flex-grow">
        <input type="number" name="durationHours" value={props.value.durationHours} onChange={props.onChange} min="0" max="99" id="first_name" className="w-full text-center border border-gray-300 text-gray-900 rounded-tl-lg rounded-bl-lg px-3 py-3.5" placeholder="00" required />
        <h1 className="bg-blue-500 text-white rounded-tr-lg rounded-br-lg flex items-center px-3 py-3.5">hrs</h1>
      </div>
      {/* Minutes */}
      <div className="flex flex-grow">
