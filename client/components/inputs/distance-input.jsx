  ...
  return (
    <fieldset className="flex mb-4">
      ...
      <div className="w-full">
        <input type="number" name="distance" min="0.01" max="999" step="0.01" value={props.distanceValue} onChange={props.onChange} className="w-full px-3 py-3.5 text-center border border-gray-300 focus:outline-blue-500 text-gray-900 rounded-lg rounded-r-none" placeholder="0.00" required />
      </div>
